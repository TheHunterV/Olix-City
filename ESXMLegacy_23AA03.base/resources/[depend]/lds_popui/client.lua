...
local pop = nil
local waiting = false
RegisterNetEvent('lds_popui:drawtextuiwithinput')
AddEventHandler('lds_popui:drawtextuiwithinput', function(table)
...
RegisterNetEvent('lds_popui:showui')
AddEventHandler('lds_popui:showui', function(table)
    if not open then
        local coord = GetEntityCoords(PlayerPedId())
        Wait(1000)
        open = false
...
RegisterNetEvent('lds_popui:closeui')
AddEventHandler('lds_popui:closeui', function(force)
