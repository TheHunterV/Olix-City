...
Config.Default_garage = 'A' -- what garage id ex. A , pillboxgarage (important to change this on some garage scripts like lds_garage)
...
Config.JunkShop = {
	['Junk Shop'] = { -- <-- dont change -- this is where your players can buy vehicle shells aka junk vehicle for project cars
		...
		event = 'lds_projectcars:openshop',
	...
	['Auto Shop'] = { -- <-- dont change -- this is where your players will buy vehicle parts
		...
		model = GetHashKey('csb_car3guy2'),
		event = Config.MetaInventory and 'lds_projectcars:openautoshop' or 'lds_projectcars:openpartlist',
...
-- integration with my vehicle shop (lds_vehicleshop v2) Soon
...
Config.BuilderJobs = {
	['mechanic'] = { -- job
		...
		event = 'lds_projectcars:gotowarehouse',
		range = 300.0,
		...
		['warehouse'] = {
			...
			['buildermenu'] = {
				label = 'Builder Menu',
				event = 'lds_projectcars:buildermenu',
				coord = vector3(-1294.5773925781,-3018.4392089844,-48.490032196045),
			},
			['garage'] = {
				label = 'Garage Menu',
				event = 'lds_projectcars:garagemenu',
				coord = vector3(-1295.2064208984,-3002.2260742188,-48.489944458008),
			},
			['stockroom'] = {
				label = 'Stock Room',
				event = Config.MetaInventory and 'lds_projectcars:stockroom' or 'lds_projectcars:openpartlist',
...
Config.parts = { -- parts initial shop price, props, labels
	...
	['paint'] = {prop = 'ng_proc_spraycan01b', price = 15000, label = 'Paint', func = 'lds_projectcars:openpaint', metaprice = 0.07},
}
