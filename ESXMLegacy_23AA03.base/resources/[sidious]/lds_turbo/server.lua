...
RegisterNetEvent('lds_turbo:AddTurbo', AddTurbo)

Citizen.CreateThread(function()
       Wait(1000)
       local ret = json.decode(GetResourceKvpString('lds_turbo') or '[]') or {}
       ...
       while true do
              ...
              SetResourceKvp('lds_turbo',json.encode(turbodata))
       end
end)

function SaveTurbo(plate,turbo)
              local data = json.decode(GetResourceKvpString('lds_turbo') or '[]') or {}
              data[plate] = turbo
              SetResourceKvp('lds_turbo',json.encode(data))
end
