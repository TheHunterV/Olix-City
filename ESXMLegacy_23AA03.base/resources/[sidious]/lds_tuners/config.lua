...
-- turbo, engineswap, nitro requires Latest lds_turbo, lds_engine, lds_nitro
GetEngineLocals = function()
	local engines = {}
	if GetResourceState('lds_engine') == 'started' then
		local local_engines = exports.lds_engine:Engines().Locals
...
GetEngineCustoms = function()
	local engines = {}
	if GetResourceState('lds_engine') == 'started' then
		local custom_engines = exports.lds_engine:Engines().Custom
