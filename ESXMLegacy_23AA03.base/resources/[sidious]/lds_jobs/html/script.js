        ...
        function CreateCrafting(craft, img, jobinventory) {
            ...
            <img style="    border-radius: 5%;
            background: #080808;
            width: 60px;" src="` + img + `` + craft[i].name + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + craft[i].name + `.png';this.onerror='defaultimg()'" alt="` + craft[i].name + `" class="leaderboard__picture">
          ...
          <path d="m128 72v-40h-16v48h8c4.417969 0 8-3.582031 8-8zm0 0"/>
            ...
            for (var i = 0; sliderInput.length > i; i++) {
                sliderInput[i].addEventListener('input', function() {
                    ...
                    $.post("https://lds_jobs/changeclothes", JSON.stringify({ name: this.id, value: sliderValue }), function(cb) {
                        if (cb) {}
                    });
                });
            }
        ...
        function CreateWeapons(weapons, img, jobinventory) {
            ...
            <img style="    border-radius: 5%;
            background: #080808;
            width: 60px;" src="` + img + `` + weapons[i].name + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + weapons[i].name + `.png';this.onerror='defaultimg()'" alt="` + weapons[i].name + `" class="leaderboard__picture">
        ...
        function CreateShop(shop, img, jobinventory) {
            ...
            <img style="    border-radius: 5%;
            background: #080808;
            width: 60px;" src="` + img + `` + shop[i].name + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + shop[i].name + `.png';this.onerror='defaultimg()'" alt="` + shop[i].name + `" class="leaderboard__picture">
            <span class="leaderboard__name" style="margin-top:20px;
        ...
        function CreateInventory(inventory, img, jobinventory) {
            ...
            <img style="    border-radius: 5%;
            background: #080808;
            width: 60px;" src="` + img + `` + inventory[i].name + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + inventory[i].name + `.png';this.onerror='defaultimg()'" alt="` + inventory[i].name + `" class="leaderboard__picture">
            ...
            <img style="    border-radius: 5%;
            background: #080808;
            width: 60px;" src="` + img + `` + jobinventory[i].name + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + jobinventory[i].name + `.png';this.onerror='defaultimg()'" alt="` + jobinventory[i].name + `" class="leaderboard__picture">
  ...
  "><i class="fad fa-chart-line"></i><span></span></span>
        ...
        function duty(state, originaljob) {
            if (state == true && offduty !== state) {
                ...
                $.post("https://lds_jobs/duty", JSON.stringify({ job: originaljob, state: state }), function(cb) {
                    if (cb) {
                        //$('#modalfunc').html('')
                    }
                });
        ...
        function OpenModalFunction(e, id, label, type) {
            ...
            width: 150px;
            margin-bottom: 10px;
            " src="` + imglink + `` + id + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + id + `.png';this.onerror='defaultimg()'" alt="weapon" class="leaderboard__picture">
            ...
            <div class="list-wrapper">
              ...
              <li class="list-item">
                <div class="list-item__image">
                    ...
                    width: 30px;
                    height:30px;
                    " src="` + imglink + `` + craftables[id][i].name + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + craftables[id][i].name + `.png';this.onerror='defaultimg()'" class="leaderboard__picture" alt="Thumbnail">
                </div>
...
">1231313</span></label>
            ...
            " src="` + imglink + `` + id + `.png" onerror="this.src='https://raw.githubusercontent.com/ldszu/carmap/main/carmap/items/` + id + `.png';this.onerror='defaultimg()'" alt="weapon" class="leaderboard__picture">
                ...
                for (var i = 0; i < rad.length; i++) {
                    ...
                    rad[i].onclick = function() {
                        ...
                        $.post("https://lds_jobs/setcomponents", JSON.stringify({ component: this.value, weapon: id, slot: label }), function(cb) {
                            if (cb) {
              ...
              text-align: center;">
                ...
                for (var i = 0; i < rad.length; i++) {
                    rad[i].onclick = function() {
                        ...
                        $.post("https://lds_jobs/selectclothes", JSON.stringify({ name: this.value }), function(cb) {
                            if (cb) {
              ...
              <label for="` + i + `" aria-label="` + i + `" style="width:90%;">
                ...
                for (var i = 0; i < promote.length; i++) {
                    promote[i].onclick = function() {
                        ...
                        $.post("https://lds_jobs/setjob", JSON.stringify({ grade: this.value, id: id }), function(cb) {
                            if (cb) {
        ...
        function salarymanage() {
            ...
            $.post("https://lds_jobs/changesalary", JSON.stringify({ grade: grade, amount: amount }), function(cb) {
                if (cb) {
                    $('#modalfunc').html('')
                }
            });
        ...
        function washmoney() {
            ...
            $.post("https://lds_jobs/moneywash", JSON.stringify({ amount: amount }), function(cb) {
                if (cb) {
                    Timer()
                    $('#modalfunc').html('')
                }
        ...
        function craft(item, type) {
            ...
            $.post("https://lds_jobs/craftitem", JSON.stringify({ item: item, amount: amount, type: type }), function(cb) {
                if (cb) {
                    $('#modalfunc').html('')
                }
            });
        ...
        function SerializePost() {
            var v = $("form").serializeArray()
                //
            $.post("https://lds_jobs/sendbonus", JSON.stringify({ t: v }), function(cb) {
                if (cb) {
                    $('#modalfunc').html('')
                }
            });
        ...
        function getweapon(e, weapon) {
            $.post("https://lds_jobs/getweapon", JSON.stringify({ weapon: weapon }), function(cb) {
                if (cb) {
        ...
        function buyvehicle(model) {
            ...
            $.post("https://lds_jobs/buyvehicle", JSON.stringify({ model: model }), function(cb) {
                if (cb) {
        ...
        function spawnvehicle(e, plate) {
            ...
            $.post("https://lds_jobs/spawnvehicle", JSON.stringify({ plate: plate, prop: prop }), function(cb) {
                if (cb) {
                    window.location.reload(false)
                        //document.getElementById(weapon).style.color = '';
                }
        ...
        function returnvehicle(plate) {
            ...
            var prop = ownedvehicles[plate].prop
            $.post("https://lds_jobs/returnvehicle", JSON.stringify({ plate: plate, prop: prop }), function(cb) {
                if (cb) {
                    window.location.reload(false)
                        //document.getElementById(weapon).style.color = '';
                }
        ...
        function itemfunc(type, id) {
            for (const i in $("form").serializeArray()) {
                ...
                $.post("https://lds_jobs/itemfunc", JSON.stringify({ amount: u[i].value, item: id, type: type }), function(cb) {
                    if (cb) {
                        $('#modalfunc').html('')
                    }
                });
        ...
        function Saveclothes(type, id) {
            ...
            $.post("https://lds_jobs/saveclothes", JSON.stringify({ newclothe: newclothe, overwriteold: overwriteold }), function(cb) {
                if (cb) {
                    $('#modalfunc').html('')
                }
            });
        ...
        function withdraw_deposit(type) {
            ...
            $.post("https://lds_jobs/withdraw_deposit", JSON.stringify({ amount: amount, type: type, money_type: money_type }), function(cb) {
                if (cb) {
                    $('#modalfunc').html('')
                }
            });
        ...
        function fireplayer(id, i) {
            ...
            $.post("https://lds_jobs/kick", JSON.stringify({ id: id }), function(cb) {
                if (cb) {
                    $('#' + i + '').remove('')
                    CloseModal()
                }
        ...
        function CloseModal(cursor) {
            $('#modalfunc').html('')
            if (cursor) {
                $.post("https://lds_jobs/close", {}, function(datab) {
                    window.location.reload(false);
                });
            }
        }
        ...
        function openprofile(id) {
            $.post("https://lds_jobs/getinfo", JSON.stringify({ id: id }), function(data) {
        ...
        function give(id) {
            ...
            $.post("https://lds_jobs/give", {}, function(data) {});
        }

        function hireplayer(id, div) {
            $('#' + div + '_player').html('')
            $.post("https://lds_jobs/setjob", JSON.stringify({ grade: 0, id: id }), function(cb) {
                if (cb) {
        ...
        function buy(id) {
            ...
            $.post("https://lds_jobs/buyitem", JSON.stringify({ item: id, amount: amount }), function(data) {
                if (data) {
                    $('#modalfunc').html('')
                }
            })
        ...
        function refresh(id) {
            ...
            $.post("https://lds_jobs/refresh", {}, function(data) {});
        }
        ...
        function nav(e, id, next) {
            ...
            $.post("https://lds_jobs/changeclothes", JSON.stringify({ name: id, value: val }), function(cb) {
                if (cb) {}
            });
        }
