...
config.keybinds = 'F7' -- Keybinds # "F6"
config.commands = 'interaction'
config.useOxInventory = true -- https://github.com/overextended/ox_inventory will disable all built in inventory of lds_jobs, and will use the ox_inventory data
config.Oxlib = true -- Ox_lib -- https://github.com/overextended/ox_lib
config.lds_Clothes = false -- https://github.com/ldszu/lds_clothes
...
-- EXTRA CONFIG
config.useSociety = false -- if using esx_society, society money will transfer to owned database lds_jobs.accounts (first load only) -- set this to false if you are unsure, and manually transfer your society money to this script
...
config.vehicleimage = 'https://raw.githubusercontent.com/ldszu/carmap/main/carmap/vehicle/' -- URL of vehicle image or path, default git contains local car image and some addon car image
...
-- WEBHOOK
config.discordwebhook = false -- enable disable webhook logs to discord
...
config.Turfs = {
    ['ballas'] = {
        schedule = 16, -- 10am
        Points = {
            Trigger = {label = 'Occupy the Territorry', coord = vec3(4.3434906005859,-1816.1579589844,29.15265083313), event = 'lds_jobs:turfoccupy'},
            vault = {label = 'Open Vault', coord = vec3(-1.5524260997772,-1811.7775878906,29.152671), event = 'lds_jobs:openvault'},
            stash = {label = 'Open Stash', coord = vec3(2.5972168445587,-1818.2747802734,29.152669), event = 'lds_jobs:openstash'},
            wardrobe = {label = 'Wardrobe', coord = vec3(-2.6590201854706,-1822.1362304688,29.547), event = 'illenium-appearance:clothingShop'},
            garage = {label = 'Garage', coord = vec3(18.048776626587,-1820.9528808594,24.93521881), event = 'lds_jobs:garage'},
        },
        garage = {
    ...
    ['triads'] = {
        schedule = 22, -- 10am
        Points = {
            Trigger = {label = 'Occupy the Territorry', coord = vec3(-652.87713623047,-1227.1003417969,11.415771484375), event = 'lds_jobs:turfoccupy'},
            vault = {label = 'Open Vault', coord = vec3(-644.42608642578,-1244.6248779297,11.992594718933), event = 'lds_jobs:openvault'},
            stash = {label = 'Open Stash', coord = vec3(-653.27209472656,-1230.4202880859,11.972341537476), event = 'lds_jobs:openstash'},
            ...
            garage = {label = 'Garage', coord = vec3(-639.03570556641,-1216.9759521484,10.763083457947), event = 'lds_jobs:garage'},
        },
        garage = {
    ...
    ['lostmc'] = {
        schedule = 10, -- 10am
        Points = {
            Trigger = {label = 'Occupy the Territorry', coord = vec3(985.09796142578,-89.706344604492,74.216796875), event = 'lds_jobs:turfoccupy'},
            vault = {label = 'Open Vault', coord = vec3(977.24432373047,-104.55417633057,75.045974731445), event = 'lds_jobs:openvault'},
            stash = {label = 'Open Stash', coord = vec3(987.21447753906,-93.189483642578,74.170722961426), event = 'lds_jobs:openstash'},
            ...
            garage = {label = 'Garage', coord = vec3(-969.64471435547,-114.96347808838,73.353096008301), event = 'lds_jobs:garage'},
        },
        garage = {
...
config.Jobs = {
    ...
    ['police'] = {
        ...
        ['vehicleshop'] = {
            ...
            event = 'lds_jobs:openvehicleshop',
            vehicles = {
