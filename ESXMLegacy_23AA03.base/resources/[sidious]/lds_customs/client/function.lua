...
function SetVehicleTurbo(vehicle, turbo)
    local plate = GetVehicleNumberPlateText(vehicle)
    TriggerServerEvent('lds_customs:custom_turbo',GetVehicleNumberPlateText(vehicle),turbo)
end

function SetVehicleEngine(vehicle, engine)
    local netid = NetworkGetNetworkIdFromEntity(vehicle)
    TriggerServerEvent('lds_customs:custom_engine',netid, GetVehicleNumberPlateText(vehicle), engine)
end
...
function SetVehicleTireType(vehicle, tire)
    local plate = GetVehicleNumberPlateText(vehicle)
    TriggerServerEvent('lds_customs:custom_tire',GetVehicleNumberPlateText(vehicle),tire)
end
