...
function ShowSubmenu(data) {
    backdata2 = data
    $.post("https://lds_customs/Reset", JSON.stringify({}));
        ...
        for (const i in data) {
            if (data[i] && data[i].label !== undefined) {
                if (i == 23) {
                    ...
                    $("#"+i+"").click(function() {
                        //$.post("https://lds_customs/ToggleTurbo", JSON.stringify({ index: data[index].list[ind]}));
                    ...
                    for (const ind in data[index].list) {
                        ...
                        $("#"+c+"").click(function() {
                            ...
                            $.post("https://lds_customs/SetExtra", JSON.stringify({ index: data[index].list[ind]}));
                            //ShowTurboMenu(data[i])
                        });
                    }
                } else if (i == 106) {
                    ...
                    for (const ind in data[index].list) {
                        ...
                        $("#"+ind+"").click(function() {
                            ...
                            $.post("https://lds_customs/SetCustomEngine", JSON.stringify({ engine: data[index].list[ind].model}));
                            //ShowTurboMenu(data[i])
                        });
                    }
                } else if (i == 107) {
                    ...
                    for (const ind in data[index].list) {
                        ...
                        $("#"+ind+"").click(function() {
                            ...
                            $.post("https://lds_customs/SetCustomTurbo", JSON.stringify({ turbo: ind}));
                            //ShowTurboMenu(data[i])
                        });
                    }
                } else if (i == 108) {
                    ...
                    for (const ind in data[index].list) {
                        ...
                        $("#"+ind+"").click(function() {
                            ...
                            $.post("https://lds_customs/SetCustomTireType", JSON.stringify({ tire: ind}));
                            //ShowTurboMenu(data[i])
                        });
                    }
                } else if (i == 99 || i == 100) {
                    ...
                    var index = i
                    $.post("https://lds_customs/SelectModIndex", JSON.stringify({ index: 'headlight'}));
                    for (const ind in data[index].list) {
                        if(ind == 'XenonLights') {
                            ...
                            $("#"+ind+"").click(function() {
                                ...
                                $.post("https://lds_customs/XenonMod", JSON.stringify({ index: data[index].list[ind]}));
                            });
                        } else if(ind == 'Default') {
                            $('#custom').append(`<button id="`+ind+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/22.svg"><div class="mod_title"><span>`+ind+`</span></div></button>`)
                            $("#"+ind+"").click(function() {
                    ...
                    var index = i
                    $.post("https://lds_customs/SelectModIndex", JSON.stringify({ index: 4}));
                    for (const ind in data[index].list) {
                        ...
                        $("#"+ind+"").click(function() {
                            ...
                            lvladd = lvl
                            document.getElementById("cost").innerHTML = totalcost.toFixed(1);
                            $.post("https://lds_customs/ChangePlate", JSON.stringify({ index: data[index].list[ind]}));
                        });
                    }
                } else if (i == 103) {
                    var index = i
                    $.post("https://lds_customs/SelectModIndex", JSON.stringify({ index: 'neon'}));
                    var haveneon = false;
                    $.post("https://lds_customs/isNeonLights", JSON.stringify({}), function(data) {
                        haveneon = data[0]
                    });
                    for (const ind in data[index].list) {
                        if(ind == 'Default') {
                            ...
                            $("#"+ind+"").click(function() {
                                ...
                                $.post("https://lds_customs/SetNeonState", JSON.stringify({ index: false}));
                            });
                        } else if(ind == 'NeonKit') {
                            $('#custom').append(`<button id="`+ind+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/neon.svg"><div class="mod_title"><span>`+ind+`</span></div></button>`)
                            $("#"+ind+"").click(function() {
                                ...
                                $.post("https://lds_customs/SetNeonState", JSON.stringify({ index: true}));
                            });
                    ...
                    var index = i
                    $.post("https://lds_customs/SelectModIndex", JSON.stringify({ index: 'window'}));
                    for (const ind in data[index].list) {
                        ...
                        $("#"+ind+"").click(function() {
                            ...
                            $.post("https://lds_customs/SetWindowTint", JSON.stringify({ index: data[index].list[ind]}));
                        });
                    }
                } else {
...
function SetCustomColor(event) {
    ...
    $.post("https://lds_customs/SetCustomColor", JSON.stringify({ r: hexToRgb(event.target.value).r, g:hexToRgb(event.target.value).g, b:hexToRgb(event.target.value).b, type:colortype}));
}

function SetNeonColor(event) {
    $.post("https://lds_customs/SetNeonColor", JSON.stringify({ r: hexToRgb(event.target.value).r, g:hexToRgb(event.target.value).g, b:hexToRgb(event.target.value).b}));
}
...
function ShowXenonMenu(data) {
    ...
    lvladd = 0
    document.getElementById("custom").innerHTML = '';
    $.post("https://lds_customs/SelectModIndex", JSON.stringify({ index: data.index}));
    setTimeout(function(){
        for (const i in data) {
            ...
            $("#"+i+"").click(function() {
                $.post("https://lds_customs/SetXenonColor", JSON.stringify({ index: data[i]}));
            });
        }
        ...
        for (const i in list) {
            if (i == 'CustomTire') {
                ...
                $("#"+i+"").click(function() {
                    ...
                    $.post("https://lds_customs/SetCustomTire", JSON.stringify({ }));
                });
                ...
                $('#custom').append(`<button id="`+i+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/28.svg"><div class="mod_title"><span>`+i+`</span></div></button>`)
                $("#"+i+"").click(function() {
                    $.post("https://lds_customs/SetBulletProofTires", JSON.stringify({ }));
                });
                ...
                $("#"+i+"").click(function() {
                    ...
                    $.post("https://lds_customs/SetDrift", JSON.stringify({ }));
                });
            }
        }
        $('#custom').prepend(`<button id="close2" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/b.svg"><div class="mod_title"><span>Back</span></div></button>`)
...
function SetSmokeColor(event) {
    $.post("https://lds_customs/SetSmokeColor", JSON.stringify({ r: hexToRgb(event.target.value).r, g:hexToRgb(event.target.value).g, b:hexToRgb(event.target.value).b, type:colortype}));
}
...
function ShowXenonOption(data,list) {
    ...
    setTimeout(function(){
        for (const i in list) {
            ...
            $("#"+i+"").click(function() {
                $.post("https://lds_customs/XenonMod", JSON.stringify({ index: list[i]}));
            });
        }
        $('#custom').prepend(`<button id="close2" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/b.svg"><div class="mod_title"><span>Back</span></div></button>`)
        $("#close2").click(function(){
...
function ShowTurboMenu(data) {
    ...
    setTimeout(function(){
        for (const i in data.list) {
            ...
            lvladd = lvl
            document.getElementById("cost").innerHTML = totalcost.toFixed(1);
                $.post("https://lds_customs/ToggleTurbo", JSON.stringify({ index: data.list[i]}));
...
function ShowIndexMenu(data,max,wheeltype) {
    ...
    var oldinstalled = -1
    var max = max
    $.post("https://lds_customs/SelectModIndex", JSON.stringify({ index: data.index}), function(ind,m) {
        setTimeout(function(){
            const mods = function() {
                var installed = ind + 1
                $.post("https://lds_customs/GetModData", JSON.stringify({ index: data.index,wheeltype:wheeltype}), function(d) {
            ...
            $("#close2").click(function(){
                ...
                setTimeout(function(){
                    ShowSubmenu(backdata2)
                    $.post("https://lds_customs/closedoor", JSON.stringify({ }), function(d) {})
                }, 100);
            });
        }, 100);
    });
...
function GetMod(index) {
    $.post("https://lds_customs/GetMod", JSON.stringify({ index: index}), function(data) {
        return data 
    });
}
...
function SetWheelColor(index) {
    ...
    $.post("https://lds_customs/SetWheelColor", JSON.stringify({ index: index}));
}
...
function SetMod(index,lvl,cost,wheeltype,label,multi) {
    ...
    lvladd = lvl
    document.getElementById("cost").innerHTML = totalcost.toFixed(1);
    $.post("https://lds_customs/SetMod", JSON.stringify({ index: index, lvl: lvl, wheeltype: wheeltype}));
}
...
function SetPaint(type,i,cost,option) {
    if (upgraded[type] == undefined) {
        ...
        $.post("https://lds_customs/GetPaint", JSON.stringify({option:option}), function(data) {
    ...
    document.getElementById("cost").innerHTML = totalcost.toFixed(1);
    $.post("https://lds_customs/SetPaint", JSON.stringify({ index: i, type: type, option:option}));
}
...
function pay() {
    ...
    $.post('https://lds_customs/pay', JSON.stringify({cost:totalcost}), function(data) {
...
function Repair() {
    $.post('https://lds_customs/repair', JSON.stringify({}), function(bool) {
        if (bool) {
...
function custompaintdone() {
    ...
    $.post("https://lds_customs/CustomPaintDone", JSON.stringify({ }));
}

function SetCustomPaint(event) {
    $.post("https://lds_customs/CustomPaint", JSON.stringify({ r: hexToRgb(event.target.value).r, g:hexToRgb(event.target.value).g, b:hexToRgb(event.target.value).b}));
}
...
$(document).on('keydown', function(event) {
    switch(event.keyCode) {
        case 27: // ESC
            document.getElementById("custom").innerHTML = '';
            $.post('https://lds_customs/Close');
            break;
        case 69: // TAB
            $.post('https://lds_customs/ToggleCamera');
            break;
        case 17: // TAB
            break;
    }
