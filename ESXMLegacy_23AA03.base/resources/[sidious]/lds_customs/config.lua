...
Config.lds_vehicleshopTable = false -- will use exports from vehicleshop vehicles table lds_vehicleshop/vehicles.lua for pricing and other data.
Config.usePopui = true -- POPUI or Drawmarker Floating Text https://github.com/ldszu/lds_popui
Config.showmarker = false -- Drawmarker and FLoating Text
...
Config.Uselds_jobs = false -- to have a profits for each upgrades https://github.com/ldszu/lds_jobs (This Have Crafting Table, Shop, Vehicle Shop, Garage and more Job Needs!) (NOT AVAILABLE IN QB)
Config.Uselds_progressbar = false -- Use Progressbar while repairing a vehicle and maybe more use case in future update https://github.com/ldszu/lds_progressbar
