...
RegisterNetEvent('lds_nitro:AddNitro', AddNitro)

Citizen.CreateThread(function()
  local ret = json.decode(GetResourceKvpString('lds_nitro') or '[]') or {}
...
function SaveNitro(nitro)
    local data = json.decode(GetResourceKvpString('lds_nitro') or '[]') or {}
    data[nitro.plate] = nitro
    SetResourceKvp('lds_nitro',json.encode(data))
end
...
RegisterServerEvent("lds_nitro:nitro_flame")
AddEventHandler("lds_nitro:nitro_flame", function(entity,coords)
	TriggerClientEvent("lds_nitro:nitro_flame", -1, entity,coords)
end)

RegisterServerEvent("lds_nitro:nitro_flame_stop")
AddEventHandler("lds_nitro:nitro_flame_stop", function(entity,coords)
	TriggerClientEvent("lds_nitro:nitro_flame_stop", -1, entity,coords)
end)
