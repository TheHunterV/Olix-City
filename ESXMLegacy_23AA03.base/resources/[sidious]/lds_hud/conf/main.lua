...
---------------------------------------------------------https://github.com/ldszu/lds_hud------------------------------------------
config = {}
...
function LockSpeed(veh,speed)
    lds_Hud(0x0E46A3FCBDE2A1B1, veh, speed)
end

function VehicleSpeed(veh)
    return lds_Hud(0xD5037BA82E12416F, veh, ReturnFloat)
end

function VehicleRpm(veh)
    return lds_Hud(0xE7B12B54, veh, ReturnFloat)
end

function WheelSpeed(veh,int)
    return lds_Hud(0x149C9DA0, veh, int, ReturnFloat)
end

function RCR(int,pad)
    return lds_Hud(0x50F940259D3841E6, int, pad)
end

function RCR2(int,pad)
    return lds_Hud(0x648EE3E7F38877DD, int, pad)
end

function RCP(int,pad)
    return lds_Hud(0xF3A21BCD95725A4A, int, pad)
end

function GetCamhead()
    return lds_Hud(0x743607648ADD4587, ReturnFloat)
end

function SetVehicleBoost(vehicle,val)
	lds_Hud(0xB59E4BD37AE292DB, vehicle,val)
end
