...
--start car map
config.centercarhud = 'map' -- Feature of Car hud - MAP , MP3 (IF YOU CHOOSE MP3 you need lds_mp3 as dependency, and lds_mp3 need xsound) (MP3 not implemented yet..lazy..)
...
config.mapurl = 'https://github.com/ldszu/carmap/blob/main/carmap/atlas.webp?raw=true' -- if use custom url define it
--atlas link https://github.com/ldszu/carmap/blob/main/carmap/oldschool.webp?raw=true
--satellite link https://github.com/ldszu/carmap/blob/main/carmap/satellite.webp
