...
config.registerautostatus = true -- register all status from config.statusordering setting below to ESX STATUS or lds_STATUS (only the status with custom bool will be registered example: line 60:status.lua) (ESX STATUS ONLY, lds_STATUS ALREADY HAVE A AUTO REGISTER FUNC)
...
config.QbcoreStatusDefault = true -- if true will use metadatas as default you can stop lds_status
...
-- custom = registered status from esx_status and lds_status
...
config.statusordering = { -- SET enable = false to disable the status (the status must be registered from your esx_status) i highly suggest to use my standalone_status (https://github.com/ldszu/lds_status) so you wont have to edit the special events and exports needed for the status System!
	...
	[1] = {type = 1, enable = true, status = 'armor', hideifmax = true, custom = false, value = 0, notify_lessthan = false, notify_message = 'i am very hungry', notify_value = 20, display = 'none', offset = '275', i_id_1_color = 'rgb(1, 103, 255)', bg = 'rgb(11, 39, 63)',fa = 'fas fa-shield-alt', i_id_2_color = 'rgb(0, 41, 129)'},
	[2] = {type = 1, enable = true, status = 'hunger', hideifmax = false, custom = true, value = 0, startvalue = 1000000, statusremove = 100, notify_lessthan = false, notify_message = 'i am very hungry', notify_value = 20, display = 'block', offset = '275', i_id_1_color = 'rgb(221, 144, 0)',bg = 'rgb(11, 39, 63)', fa = 'fas fa-hamburger', i_id_2_color = 'rgb(114, 68, 0)'},
	[3] = {type = 1, enable = true, status = 'thirst', hideifmax = false, custom = true, value = 0, startvalue = 1000000, statusremove = 100, notify_lessthan = false, notify_message = 'i am very thirsty', notify_value = 20, display = 'block', offset = '275', i_id_1_color = 'rgb(36, 113, 255)',bg = 'rgb(11, 39, 63)', fa = 'fas fa-glass-whiskey', i_id_2_color = 'rgb(0, 11, 112)'},
	...
	[5] = {type = 1, enable = true, status = 'stamina', hideifmax = true, min_val_hide = 100, custom = false, value = 0, notify_lessthan = false, notify_message = 'running makes me thirsty', notify_value = 20, display = 'block', offset = '275', i_id_1_color = 'rgb(16, 255, 136)',bg = 'rgb(11, 39, 63)', fa = 'fas fa-running', i_id_2_color = 'rgba(0, 119, 57, 0.94)'},
	[6] = {type = 1, enable = true, status = 'oxygen', hideifmax = true, min_val_hide = 100, custom = false, value = 0, notify_lessthan = false, notify_message = 'my oxygen is almost gone', notify_value = 20, display = 'block', offset = '275', i_id_1_color = 'rgb(15, 227, 255)',bg = 'rgb(11, 39, 63)', fa = 'fas fa-lungs', i_id_2_color = 'rgba(8, 76, 85, 0.78)'},
	[7] = {type = 1, enable = true, status = 'energy', hideifmax = true, min_val_hide = 50, custom = true, value = 0, startvalue = 1000000, statusremove = 100, notify_lessthan = false, notify_message = 'i am very tired', notify_value = 20, display = 'block', offset = '275', i_id_1_color = 'rgb(233, 233, 233)',bg = 'rgb(11, 39, 63)', fa = 'fas fa-bed', i_id_2_color = 'color:rgb(243, 57, 0)'},
	...
	[9] = {
		...
		status = 'poop',  -- status name from esx_status or lds_status
		...
		custom = true, -- native (ex. oxygen) or custom (Esx status/lds_status)
		value = 0, -- leave default 0
		startvalue = 1000000,
		statusremove = 100, -- this will be register to esx_status or lds_status, ( this is the remove value per tick )
...
-- custom = true/false -- this define if the status is registered to esx_status/lds_status/ -- if false its a native status example: oxygen,stamina
