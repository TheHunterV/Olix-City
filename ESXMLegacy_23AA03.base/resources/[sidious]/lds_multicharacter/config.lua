...
Config.SpawnSelectorExport = function(coord) -- by default it uses my spawn resource
	return exports.lds_spawn:Selector({x = coord.x, y = coord.y, z = coord.z, heading = coord.w})
end
-- intro
...
Config.SkinMenus = {
	...
	['illeniumappearance'] = {
		['illenium-appearance'] = { event = 'illenium-appearance:client:openOutfitMenu', use = true},
	}, -- is there any creator uses fivemappearance? i will leave this todo for now
...
-- exports.lds_multicharacter:RegisterComplete(source, {
