...
registercallback('lds_multicharacter:choosecharacter', function(source,slot)
...
registercallback('lds_multicharacter:createcharacter', function(source,data)
	local source = source
	local data = data
...
registercallback('lds_multicharacter:deletecharacter', function(source,slot)
	return Config.CanDelete and DeleteCharacter(source,slot)
end)

registercallback('lds_multicharacter:saveappearance', function(source,skin)
