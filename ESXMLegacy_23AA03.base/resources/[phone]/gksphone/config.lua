...
Config.Carseller = '' --Webhook_here
Config.JobNotif = '' --Webhook_here
Config.TwitterWeb = '' --Webhook_here 
Config.YellowWeb = '' --Webhook_here
Config.InstagramWeb = '' --Webhook_here
Config.Crypto = '' --Webhook_here
Config.BankTrasnfer = '' --Webhook_here
Config.BankLimit = 1 -- # Minimum money transfer for discord webhook
-- Discord WebHook - end --
