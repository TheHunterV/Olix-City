return {
	...
	Ammunation = {
		...
		blip = {
			...
			{ name = 'WEAPON_PUMPSHOTGUN', price = 1500, metadata = { registered = true }, license = 'weapon' },
			{ name = 'WEAPON_VINTAGEPISTOL', price = 800, metadata = { registered = true }, license = 'weapon' },
			{ name = 'WEAPON_REVOLVER', price = 3200, metadata = { registered = true }, license = 'weapon' },
			{ name = 'WEAPON_SAWNOFFSHOTGUN', price = 1300, metadata = { registered = true }, license = 'weapon' },
			{ name = 'WEAPON_DOUBLEACTION', price = 1800, metadata = { registered = true }, license = 'weapon' },
