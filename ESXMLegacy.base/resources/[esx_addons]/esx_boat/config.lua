...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 3500},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 4000},
	{model = 'suntrap', label = 'Suntrap', price = 10000},
	{model = 'jetmax', label = 'Jetmax', price = 45000},
	{model = 'tropic2', label = 'Tropic', price = 65000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 38500},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 32500},
	{model = 'speeder', label = 'Speeder', price = 85000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 61000},
	{model = 'toro', label = 'Toro', price = 95000},
	{model = 'submersible', label = 'Submersible', price = 550000}
}
